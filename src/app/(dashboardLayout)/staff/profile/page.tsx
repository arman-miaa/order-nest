    ...
    <div className="space-y-6 pb-12">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="text-slate-500">Manage staff account details and contact information.</p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input id="staff-name" value={values.name} onChange={(e) => setForm((prev) => ({ ...prev, name: e.target.value }))} />
            </div>
            <div>
              <Label htmlFor="staff-email">Email</Label>
              <Input id="staff-email" type="email" value={values.email} onChange={(e) => setForm((prev) => ({ ...prev, email: e.target.value }))} />
            </div>
            <div>
              <Label htmlFor="staff-phone">Phone</Label>
              <Input id="staff-phone" value={values.phone} onChange={(e) => setForm((prev) => ({ ...prev, phone: e.target.value }))} />
            </div>
