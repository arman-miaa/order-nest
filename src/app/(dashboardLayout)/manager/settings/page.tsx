    ...
    <div className="space-y-6 pb-12">
      ...
      <div>
        ...
        <p className="text-slate-500 mt-1">
          Configure restaurant preferences, billing, notifications, and system
          behavior.
        </p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-100">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Basic restaurant details and regional settings
              </p>
            </div>
          </div>
          ...
          <div className="space-y-5">
            ...
            <button
              ...
              className="w-full rounded-xl bg-slate-900 hover:bg-slate-800 py-3 text-sm font-bold text-white shadow-xs transition flex items-center justify-center gap-2"
            >
              {saved === "Restaurant" ? (
        ...
        <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-100">
            ...
            <div>
              <h2 className="text-lg font-bold text-slate-900">
                Kitchen Timing Rules
              </h2>
              <p className="text-xs text-slate-500">
                Default prep time and overdue alert thresholds
              </p>
            </div>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-slate-400">
                Orders exceeding this duration will be flagged red on all
                screens.
              </p>
            </div>
        ...
        <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-100">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Control which alerts appear on the manager screen
              </p>
            </div>
          </div>
        ...
        <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-100">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Realtime architecture and data integrity configuration
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 pt-4 border-t border-slate-100 space-y-3">
            <button
              ...
              className="w-full rounded-xl border border-slate-200 bg-white hover:bg-slate-50 py-3 text-sm font-bold text-slate-700 shadow-xs transition flex items-center justify-center gap-2"
            >
            ...
            <button
              onClick={() => {
                if (typeof window !== "undefined")
                  localStorage.removeItem("ordernest_state");
                toast.success("System state cleared. Reload to reset demo data.");
              }}
              className="w-full rounded-xl border border-red-100 bg-red-50 hover:bg-red-100/80 py-3 text-sm font-bold text-red-700 shadow-xs transition flex items-center justify-center gap-2"
            >
