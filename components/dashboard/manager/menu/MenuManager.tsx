                  ...
                  >
                      ...
                      {editingItemId === item.id ? (
                        <div className="flex items-center gap-1.5">
                          ...
                          <button
                            ...
                            className="rounded-lg bg-emerald-500 p-1 text-white hover:bg-emerald-600 cursor-pointer"
                          >
                        ...
                        <div className="flex items-center gap-2 font-bold text-slate-900 group">
                          ...
                          <button
                            ...
                            className="rounded-md p-1 text-slate-400 hover:text-slate-600 hover:bg-slate-100 opacity-0 group-hover:opacity-100 transition cursor-pointer"
                          >
                    ...
                    <td className="py-4 text-center" onClick={(e) => e.stopPropagation()}>
                      <div className="flex items-center justify-center">
                        ...
                        <span
                          className={`text-[10px] font-bold ml-2 uppercase w-14 text-left ${
              ...
              <div className="space-y-6 flex-1 flex flex-col justify-between">
                <div>
                  <div className="border-b border-slate-100 pb-4">
                    ...
                    <h3 className="text-xl font-extrabold text-slate-900 mt-1 font-sans">
                      {selectedItem.name}
                    </h3>
                  </div>
                  ...
                  <div className="mt-5 space-y-4 text-sm">
                    ...
                    <div className="grid grid-cols-2 gap-4 border-t border-slate-100 pt-4">
                      <div>
                        ...
                        <span className="font-semibold text-slate-800 uppercase text-xs mt-1 block">
                          {selectedItem.id}
                        </span>
                      </div>
                      <div>
                    ...
                    <div className="border-t border-slate-100 pt-4">
                      ...
                      <span className="text-2xl font-extrabold text-slate-950 mt-1 block">
                      ...
                      <div>
                        ...
                        <span
                          className={`text-xs font-bold mt-1 block ${
                            selectedItem.inStock ? "text-emerald-600" : "text-red-500"
                          }`}
                        >
                ...
                <div className="rounded-xl border border-dashed border-slate-200 p-4 text-[11px] leading-relaxed text-slate-500 bg-slate-50/50 mt-6">
                  <strong>Manager Tip:</strong> Toggling an item to "86" blocks it in real-time
                  from the staff tablet order screen to prevent ordering unavailable items.
                </div>
              </div>
            )}
          </div>
